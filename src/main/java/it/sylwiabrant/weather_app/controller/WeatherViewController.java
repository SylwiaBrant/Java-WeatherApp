...
public class WeatherViewController extends BaseController implements Initializable {
    ...
    public void setCurrentWeatherView() {
        Map<Integer, CurrentWeather> currentWeathers = weatherData.getCurrentWeathers();
    ...
    public void setForecastView() {
        Map<Integer, List<ForecastWeather>> forecasts = weatherData.getForecasts();
        setForecastPerCity((ArrayList<ForecastWeather>) forecasts.get(0), forecastGrid1);
        setForecastPerCity((ArrayList<ForecastWeather>) forecasts.get(1), forecastGrid2);
    }
    ...
    public void updateCityView(int index) {
        Label cityLabel;
        GridPane currentWeatherPane;
        GridPane forecastPane;
        CurrentWeather currentWeather = weatherData.getSingleCityWeather(index);
        List<ForecastWeather> forecastWeather = weatherData.getSingleCityForecasts(index);
        ...
        setForecastPerCity((ArrayList<ForecastWeather>) forecastWeather, forecastPane);
    }
}
